...
const ContactCardComponent = ({ contact, onEdit, onDelete, isHighlighted, id }: ContactCardProps) => {
  ...
  return (
    ...
    >
      {/* Subtle tier indicator with gentle hover effect */}
      <div className={`relative h-1 w-full bg-gradient-to-r transition-all duration-300 ease-out group-hover:h-1.5 ${
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-white/2 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none rounded-lg" />
      
      <div className="relative p-6">
        {/* Header section */}
        <div className="flex items-start justify-between mb-4">
          <div className="flex items-center space-x-3">
            {/* Avatar with subtle scale and glow */}
        ...
        {/* Contact details with subtle hover effects */}
